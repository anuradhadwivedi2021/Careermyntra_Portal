...
#
# All routes read live from `cap_cutoff_data`, so results always match
# whatever data is actually in the DB (no hardcoded maps).
...
# ─── University → Districts ──────────────────────────────────
# GET /college-predictor/districts-by-university?universities=Savitribai Phule Pune University
...
# GET /college-predictor/categories-by-filters?districts=Pune,Nashik&universities=X
...
# GET /college-predictor/genders-by-filters?category=OPEN&districts=Pune&universities=X&branches=Y
...
# GET /college-predictor/cascading-options?districts=..&universities=..&category=..&branches=..&gender=..&cap_year=..&cap_round=..
