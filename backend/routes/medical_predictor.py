...
# NOTE: Saved-student routes (save/list/search/get/delete) live in their
# own dedicated file — routes/medical_student_data.py — not in this file.
# See that file's header comment for the full route list.